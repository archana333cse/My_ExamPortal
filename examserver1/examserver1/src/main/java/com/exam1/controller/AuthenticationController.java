...
import com.exam1.config.JwtUtils;
import com.exam1.helper.UserNotFoundException;
import com.exam1.model.JwtRequest;
import com.exam1.model.JwtResponse;
...
public class AuthenticationController {
    ...
    private void authentication(String username, String password) throws Exception {
        try {
            ...
            throw new Exception("Invalid crediantials "+e.getMessage());
        }
